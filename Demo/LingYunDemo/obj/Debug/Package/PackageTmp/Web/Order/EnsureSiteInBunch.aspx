<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnsureSiteInBunch.aspx.cs" Inherits="LingYunDemo.Web.Order.EnsureSiteInBunch" %>
...
<body>
<h4  style="height:32px;line-height:32px;padding-left:20px; border-bottom:3px solid #F53C4A;color:#000;font-size:16px;">用户导航：现场仓储->确认入库批次</h4>
