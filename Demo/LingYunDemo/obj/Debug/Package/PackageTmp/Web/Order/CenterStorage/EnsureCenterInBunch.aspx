<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnsureCenterInBunch.aspx.cs" Inherits="LingYunDemo.Web.Order.CenterStorage.EnsureCenterInBunch" %>
...
<body><h4  style="height:32px;line-height:32px;padding-left:20px; border-bottom:3px solid #F53C4A;color:#000;font-size:16px;">用户导航：中心仓储->确认入库批次表</h4>
