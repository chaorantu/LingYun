<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnsureProductInBunch.aspx.cs" Inherits="LingYunDemo.Web.Order.EnsureProductInBunch" %>
...
<body>
<h4  style="height:32px;line-height:32px;padding-left:20px; border-bottom:3px solid #F53C4A;color:#000;font-size:16px;">用户导航：加工中心->确认入库批次表</h4>
   ...
   <td><input type="text" runat="server" id="txbBuildBatchID" disabled="disabled"/></td>
   </tr>
   <tr>
   <td><span>工程名</span></td>
