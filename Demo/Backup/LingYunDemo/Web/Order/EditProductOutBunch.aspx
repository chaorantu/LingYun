<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProductOutBunch.aspx.cs" Inherits="LingYunDemo.Web.Order.EditProductOutBunch" %>
...
<body>
<h4  style="height:32px;line-height:32px;padding-left:20px; border-bottom:3px solid #F53C4A;color:#000;font-size:16px;">用户导航：加工中心->编辑出库批次表</h4>
   ...
   <td><input type="text" runat="server" id="txbCount" /></td>
    ...
    <tr>
   <td><asp:CheckBox ID="CheckBox1" runat="server" Text="打印条码" /></td>
   <td> <asp:TextBox ID="txbPrintCount" runat="server" Width="102px"></asp:TextBox>

        <asp:Button ID="ensure" runat="server" Text="确定" onclick="ensure_Click"    Width="82px" /></td>
  </tr>
 </table>
